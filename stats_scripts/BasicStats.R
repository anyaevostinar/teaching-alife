...
setwd("~/Desktop/Teaching361/evo-algo/Example/")
...
ggplot(data=update_1, aes(x=count, y=mean_coopval, group=treatment, colour=treatment)) +ylab("Mean Cooperation Value") + xlab("Number of Organisms") + geom_point()
